...
**Kural:** Bytecode artifact'ları bu discriminant'a bağımlı olabileceği için discriminant'ı kararlı tut. Değer experimental ise bu durumu `docs/isa_ve_bytecode.md` dosyasında belgele.
