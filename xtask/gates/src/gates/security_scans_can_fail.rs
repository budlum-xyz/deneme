...
const ALLOWED: &[Allowed] = &[
    ...
    Allowed {
        file: "diagnostic-clippy.yml",
        what: "full-report",
        reason: "diagnostic raporlama isidir, kapi degildir: clippy JSON'i `|| true` ile toplanir cunku derleme hatasi da raporlanmasi gereken bir sonuctur; gercek kapi (ci.yml'deki clippy-extra) ayrica bloklar",
    },
